...
if(!org.hsl.js.translation.progress) org.hsl.js.translation.progress = {}
org.hsl.js.translation.progress.LoadProgressTranslator = function(p) { if( p === $_ ) return; {
	null;
}}
org.hsl.js.translation.progress.LoadProgressTranslator.__name__ = ["org","hsl","js","translation","progress","LoadProgressTranslator"];
org.hsl.js.translation.progress.LoadProgressTranslator.prototype.translate = function(nativeEvent) {
	var progressEvent = nativeEvent;
	var loaded = 0;
	var total = 0;
	...
	return new org.hsl.haxe.translation.Translation(new org.hsl.js.translation.progress.LoadProgress(loaded,total),progressEvent.target);
}
org.hsl.js.translation.progress.LoadProgressTranslator.prototype.__class__ = org.hsl.js.translation.progress.LoadProgressTranslator;
org.hsl.js.translation.progress.LoadProgressTranslator.__interfaces__ = [org.hsl.haxe.translation.Translator];
if(!org.hsl.js.translation.error) org.hsl.js.translation.error = {}
org.hsl.js.translation.error.ErrorMessage = function(statusCode,text) { if( statusCode === $_ ) return; {
	this.statusCode = statusCode;
	this.text = text;
}}
org.hsl.js.translation.error.ErrorMessage.__name__ = ["org","hsl","js","translation","error","ErrorMessage"];
org.hsl.js.translation.error.ErrorMessage.prototype.statusCode = null;
org.hsl.js.translation.error.ErrorMessage.prototype.text = null;
org.hsl.js.translation.error.ErrorMessage.prototype.__class__ = org.hsl.js.translation.error.ErrorMessage;
if(!org.grumpytoad) org.grumpytoad = {}
if(!org.grumpytoad.hslexample) org.grumpytoad.hslexample = {}
if(!org.grumpytoad.hslexample.progress) org.grumpytoad.hslexample.progress = {}
org.grumpytoad.hslexample.progress.Main = function(p) { if( p === $_ ) return; {
	var url = null;
	if(new EReg("doerror=true","").match(js.Lib.document.location.href)) {
		url = "./ulysses2.txt";
		this.doError = true;
	}
	else {
	...
	var progressSignaler = new org.hsl.js.translation.JSTranslatingSignaler(this.xmlHttpRequest,this.xmlHttpRequest,org.hsl.js.translation.JSEventType.PROGRESS,new org.hsl.js.translation.progress.LoadProgressTranslator());
	progressSignaler.addSlot($closure(this,"modifyProgress"));
	var completeSignaler = new org.hsl.js.translation.JSTranslatingSignaler(this.xmlHttpRequest,this.xmlHttpRequest,org.hsl.js.translation.JSEventType.LOAD,new org.hsl.js.translation.DatalessTranslator());
	completeSignaler.addSlot($closure(this,"complete"));
	var errorSignaler = new org.hsl.js.translation.JSTranslatingSignaler(this.xmlHttpRequest,this.xmlHttpRequest,org.hsl.js.translation.JSEventType.ERROR,new org.hsl.js.translation.error.ErrorMessageTranslator());
	errorSignaler.addSlot($closure(this,"error"));
	this.xmlHttpRequest.open("GET",url,true);
	this.xmlHttpRequest.send(null);
	var result = js.Lib.document.getElementById("result");
	js.Lib.window["xmlHttpRequest"] = this.xmlHttpRequest;
}}
org.grumpytoad.hslexample.progress.Main.__name__ = ["org","grumpytoad","hslexample","progress","Main"];
org.grumpytoad.hslexample.progress.Main.main = function() {
	new org.grumpytoad.hslexample.progress.Main();
}
org.grumpytoad.hslexample.progress.Main.prototype.complete = function(signal) {
	if(this.doError) return;
	var tag = js.Lib.document.createElement("div");
	tag.style.width = "100%";
	tag.style.height = "100%";
	tag.style.backgroundColor = "#000";
	var bar = js.Lib.document.getElementById("bar");
	if(bar.firstChild != null) bar.removeChild(bar.firstChild);
	bar.appendChild(tag);
	var result = js.Lib.document.getElementById("result");
	result.innerHTML = (function($this) {
		var $r;
		var tmp = signal.initialSubject;
		$r = (Std["is"](tmp,js.XMLHttpRequest)?tmp:(function($this) {
			var $r;
...
org.grumpytoad.hslexample.progress.Main.prototype.doError = null;
org.grumpytoad.hslexample.progress.Main.prototype.error = function(signal) {
	var result = js.Lib.document.getElementById("result");
	result.innerHTML = (("Error code " + signal.data.statusCode) + " with message ") + signal.data.text;
}
org.grumpytoad.hslexample.progress.Main.prototype.modifyProgress = function(signal) {
	var tag = js.Lib.document.createElement("div");
...
org.grumpytoad.hslexample.progress.Main.prototype.xmlHttpRequest = null;
org.grumpytoad.hslexample.progress.Main.prototype.__class__ = org.grumpytoad.hslexample.progress.Main;
...
org.hsl.js.translation.progress.LoadProgress = function(numberOfBytesLoaded,numberOfBytesTotal) { if( numberOfBytesLoaded === $_ ) return; {
	this.numberOfBytesLoaded = numberOfBytesLoaded;
	this.numberOfBytesTotal = numberOfBytesTotal;
	if(numberOfBytesTotal != 0) {
		this.progress = numberOfBytesLoaded / numberOfBytesTotal;
	}
}}
org.hsl.js.translation.progress.LoadProgress.__name__ = ["org","hsl","js","translation","progress","LoadProgress"];
org.hsl.js.translation.progress.LoadProgress.prototype.numberOfBytesLoaded = null;
org.hsl.js.translation.progress.LoadProgress.prototype.numberOfBytesTotal = null;
org.hsl.js.translation.progress.LoadProgress.prototype.progress = null;
org.hsl.js.translation.progress.LoadProgress.prototype.__class__ = org.hsl.js.translation.progress.LoadProgress;
...
org.hsl.js.translation.error.ErrorMessageTranslator = function(p) { if( p === $_ ) return; {
	null;
}}
org.hsl.js.translation.error.ErrorMessageTranslator.__name__ = ["org","hsl","js","translation","error","ErrorMessageTranslator"];
org.hsl.js.translation.error.ErrorMessageTranslator.prototype.translate = function(nativeEvent) {
	var errorEvent = nativeEvent;
	var xmlHttpRequest;
	try {
		xmlHttpRequest = (function($this) {
			var $r;
			var tmp = errorEvent.target;
			$r = (Std["is"](tmp,js.XMLHttpRequest)?tmp:(function($this) {
				var $r;
				throw "Class cast error";
				return $r;
	...
	return new org.hsl.haxe.translation.Translation(new org.hsl.js.translation.error.ErrorMessage(xmlHttpRequest.status,xmlHttpRequest.statusText),errorEvent.target);
}
org.hsl.js.translation.error.ErrorMessageTranslator.prototype.__class__ = org.hsl.js.translation.error.ErrorMessageTranslator;
org.hsl.js.translation.error.ErrorMessageTranslator.__interfaces__ = [org.hsl.haxe.translation.Translator];
...
js.Lib.onerror = null;
$Main.init = org.grumpytoad.hslexample.progress.Main.main();
