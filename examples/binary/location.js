...
if(!org.grumpytoad.hslexample.location) org.grumpytoad.hslexample.location = {}
org.grumpytoad.hslexample.location.Main = function(p) { if( p === $_ ) return; {
	var sniff = js.Lib.document.getElementById("sniff");
	var locationSignaler = new org.hsl.js.translation.JSTranslatingSignaler(sniff,sniff,org.hsl.js.translation.JSEventType.MOUSEMOVE,new org.hsl.js.translation.mouse.MouseLocationTranslator());
	locationSignaler.addSlot($closure(this,"onMove"));
}}
org.grumpytoad.hslexample.location.Main.__name__ = ["org","grumpytoad","hslexample","location","Main"];
org.grumpytoad.hslexample.location.Main.main = function() {
	new org.grumpytoad.hslexample.location.Main();
}
org.grumpytoad.hslexample.location.Main.prototype.onMove = function(signal) {
	var result = js.Lib.document.getElementById("result");
	result.innerHTML = (((((("x: " + signal.data.x) + ", y: ") + signal.data.y) + ", globalX: ") + signal.data.globalLocation.x) + ", globalY: ") + signal.data.globalLocation.y;
}
org.grumpytoad.hslexample.location.Main.prototype.__class__ = org.grumpytoad.hslexample.location.Main;
Std = function() { }
Std.__name__ = ["Std"];
Std["is"] = function(v,t) {
...
org.hsl.js.translation.mouse.MouseLocationTranslator = function(p) { if( p === $_ ) return; {
	null;
}}
org.hsl.js.translation.mouse.MouseLocationTranslator.__name__ = ["org","hsl","js","translation","mouse","MouseLocationTranslator"];
org.hsl.js.translation.mouse.MouseLocationTranslator.__super__ = org.hsl.js.translation.JSCommonTranslator;
for(var k in org.hsl.js.translation.JSCommonTranslator.prototype ) org.hsl.js.translation.mouse.MouseLocationTranslator.prototype[k] = org.hsl.js.translation.JSCommonTranslator.prototype[k];
org.hsl.js.translation.mouse.MouseLocationTranslator.prototype.translate = function(nativeEvent) {
	...
	return new org.hsl.haxe.translation.Translation(localMouseLocation,target);
}
org.hsl.js.translation.mouse.MouseLocationTranslator.prototype.__class__ = org.hsl.js.translation.mouse.MouseLocationTranslator;
org.hsl.js.translation.mouse.MouseLocationTranslator.__interfaces__ = [org.hsl.haxe.translation.Translator];
...
js.Lib.onerror = null;
$Main.init = org.grumpytoad.hslexample.location.Main.main();
