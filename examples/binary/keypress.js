...
if(!org.hsl.js.translation.keyboard) org.hsl.js.translation.keyboard = {}
org.hsl.js.translation.keyboard.KeyCodeTranslator = function(p) { if( p === $_ ) return; {
	null;
}}
org.hsl.js.translation.keyboard.KeyCodeTranslator.__name__ = ["org","hsl","js","translation","keyboard","KeyCodeTranslator"];
org.hsl.js.translation.keyboard.KeyCodeTranslator.__super__ = org.hsl.js.translation.JSCommonTranslator;
for(var k in org.hsl.js.translation.JSCommonTranslator.prototype ) org.hsl.js.translation.keyboard.KeyCodeTranslator.prototype[k] = org.hsl.js.translation.JSCommonTranslator.prototype[k];
org.hsl.js.translation.keyboard.KeyCodeTranslator.prototype.translate = function(nativeEvent) {
	var keyboardEvent = this.getEvent(nativeEvent);
	...
	return new org.hsl.haxe.translation.Translation(code,target);
}
org.hsl.js.translation.keyboard.KeyCodeTranslator.prototype.__class__ = org.hsl.js.translation.keyboard.KeyCodeTranslator;
org.hsl.js.translation.keyboard.KeyCodeTranslator.__interfaces__ = [org.hsl.haxe.translation.Translator];
if(!org.grumpytoad) org.grumpytoad = {}
if(!org.grumpytoad.hslexample) org.grumpytoad.hslexample = {}
if(!org.grumpytoad.hslexample.keypress) org.grumpytoad.hslexample.keypress = {}
org.grumpytoad.hslexample.keypress.Main = function(p) { if( p === $_ ) return; {
	var locationSignaler = new org.hsl.js.translation.JSTranslatingSignaler(js.Lib.document,js.Lib.document,org.hsl.js.translation.JSEventType.KEYUP,new org.hsl.js.translation.keyboard.KeyCodeTranslator());
	locationSignaler.addSlot($closure(this,"onKey"));
}}
org.grumpytoad.hslexample.keypress.Main.__name__ = ["org","grumpytoad","hslexample","keypress","Main"];
org.grumpytoad.hslexample.keypress.Main.main = function() {
	new org.grumpytoad.hslexample.keypress.Main();
}
org.grumpytoad.hslexample.keypress.Main.prototype.onKey = function(signal) {
	var result = js.Lib.document.getElementById("result");
	result.innerHTML = "key pressed is: " + String.fromCharCode(signal.data);
}
org.grumpytoad.hslexample.keypress.Main.prototype.__class__ = org.grumpytoad.hslexample.keypress.Main;
...
js.Lib.onerror = null;
$Main.init = org.grumpytoad.hslexample.keypress.Main.main();
