...
org.hsl.js.translation.mouse.MouseCondition = function(location,modifierKeysState) { if( location === $_ ) return; {
	this.location = location;
	this.modifierKeysState = modifierKeysState;
}}
org.hsl.js.translation.mouse.MouseCondition.__name__ = ["org","hsl","js","translation","mouse","MouseCondition"];
org.hsl.js.translation.mouse.MouseCondition.prototype.location = null;
org.hsl.js.translation.mouse.MouseCondition.prototype.modifierKeysState = null;
org.hsl.js.translation.mouse.MouseCondition.prototype.__class__ = org.hsl.js.translation.mouse.MouseCondition;
...
if(!org.grumpytoad.hslexample.mousecondition) org.grumpytoad.hslexample.mousecondition = {}
org.grumpytoad.hslexample.mousecondition.Main = function(p) { if( p === $_ ) return; {
	var locationSignaler = new org.hsl.js.translation.JSTranslatingSignaler(js.Lib.document,js.Lib.document,org.hsl.js.translation.JSEventType.MOUSEMOVE,new org.hsl.js.translation.mouse.MouseConditionTranslator());
	locationSignaler.addSlot($closure(this,"onMouseMove"));
}}
org.grumpytoad.hslexample.mousecondition.Main.__name__ = ["org","grumpytoad","hslexample","mousecondition","Main"];
org.grumpytoad.hslexample.mousecondition.Main.main = function() {
	new org.grumpytoad.hslexample.mousecondition.Main();
}
org.grumpytoad.hslexample.mousecondition.Main.prototype.onMouseMove = function(signal) {
	var result = js.Lib.document.getElementById("result");
	result.innerHTML = ((((((((("mouse location is: " + signal.data.location.x) + ", ") + signal.data.location.y) + "<br />") + "alt: ") + signal.data.modifierKeysState.altKeyDown) + ", ctrl: ") + signal.data.modifierKeysState.controlKeyDown) + ", shift: ") + signal.data.modifierKeysState.shiftKeyDown;
}
org.grumpytoad.hslexample.mousecondition.Main.prototype.__class__ = org.grumpytoad.hslexample.mousecondition.Main;
...
org.hsl.js.translation.mouse.MouseConditionTranslator = function(p) { if( p === $_ ) return; {
	null;
}}
org.hsl.js.translation.mouse.MouseConditionTranslator.__name__ = ["org","hsl","js","translation","mouse","MouseConditionTranslator"];
org.hsl.js.translation.mouse.MouseConditionTranslator.__super__ = org.hsl.js.translation.JSCommonTranslator;
for(var k in org.hsl.js.translation.JSCommonTranslator.prototype ) org.hsl.js.translation.mouse.MouseConditionTranslator.prototype[k] = org.hsl.js.translation.JSCommonTranslator.prototype[k];
org.hsl.js.translation.mouse.MouseConditionTranslator.prototype.translate = function(nativeEvent) {
	var mouseEvent = this.getEvent(nativeEvent);
	var target = this.targetFromDOMEvent(mouseEvent);
	var localMouseLocation = this.localMouseLocationFromDOMEvent(mouseEvent,target);
	return new org.hsl.haxe.translation.Translation(new org.hsl.js.translation.mouse.MouseCondition(localMouseLocation,new org.hsl.js.translation.mouse.ModifierKeysState(mouseEvent.altKey,mouseEvent.ctrlKey,mouseEvent.shiftKey)),target);
}
org.hsl.js.translation.mouse.MouseConditionTranslator.prototype.__class__ = org.hsl.js.translation.mouse.MouseConditionTranslator;
org.hsl.js.translation.mouse.MouseConditionTranslator.__interfaces__ = [org.hsl.haxe.translation.Translator];
...
org.hsl.js.translation.mouse.ModifierKeysState = function(altKeyDown,controlKeyDown,shiftKeyDown) { if( altKeyDown === $_ ) return; {
	this.altKeyDown = altKeyDown;
	this.controlKeyDown = controlKeyDown;
	this.shiftKeyDown = shiftKeyDown;
}}
org.hsl.js.translation.mouse.ModifierKeysState.__name__ = ["org","hsl","js","translation","mouse","ModifierKeysState"];
org.hsl.js.translation.mouse.ModifierKeysState.prototype.altKeyDown = null;
org.hsl.js.translation.mouse.ModifierKeysState.prototype.controlKeyDown = null;
org.hsl.js.translation.mouse.ModifierKeysState.prototype.shiftKeyDown = null;
org.hsl.js.translation.mouse.ModifierKeysState.prototype.__class__ = org.hsl.js.translation.mouse.ModifierKeysState;
...
js.Lib.onerror = null;
$Main.init = org.grumpytoad.hslexample.mousecondition.Main.main();
